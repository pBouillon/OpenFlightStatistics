...
import projet_top.airport.{Airport, AirportDistanceMap}

object AirportDistanceMapTestObject {

  val airportDistanceMap: AirportDistanceMap = AirportDatabaseTestObjects.airportDatabase.getDistanceMap
...
class AirportDistanceMapGetDistanceBetweenTest extends FlatSpec {
  ...
  it should "throw a distance between airports in the map" in {
    val expected = 15.725331604303992
    val possibleAirport1 = AirportDatabaseTestObjects.airportDatabase.getAirportById(1)
