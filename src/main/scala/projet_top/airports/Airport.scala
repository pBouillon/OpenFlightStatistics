...
/**
  * Objet compagnon de la classe projet_top.airports.Airport. Contient les méthodes et champs statiques pour cette dernière
  */
object Airport {
  /**
...
/**
  * Classe immuable qui contient les données relatives à un aéroport. Sert principalement dans la classe projet_top.airports.AirportDatabase, et possède peu/pas de méthodes
  */
